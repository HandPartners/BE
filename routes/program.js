...
const uploadImg = multer({
  storage: multer.diskStorage({
    destination(req, file, callback) {
      ...
      const dir = `uploads/${year}${month}${day}/program`;
...
router.get('/', controller.getProgramList);
router.get('/:id', controller.getProgramDetail);
router.post(
  '/new',
  uploadImg.fields([
...
router.get('/update/:id', controller.getProgramUpdate);
router.patch(
  '/:id',
  uploadImg.fields([
    { name: 'thumbnail', maxCount: 1 },
